...
it <- data.table::data.table(
  ...
  l   = c(2.140000, 7.240000, 7.240000, 2.140000, 7.240000, 7.240000, 6.000000, 4.000000, 9.8, 9.9),
  d   = c(3.580000, 7.240000, 7.240000, 3.580000, 7.240000, 7.240000, 6.000000, 4.000000, 6.6, 7.8),
  h   = c(4.760000, 2.580000, 2.580000, 4.760000, 2.580000, 2.580000, 6.000000, 4.000000, 12, 17.5),
  w   = c(3.0000, 10.5, 2.4, 243.0000, 13.13, 24.2, 2.3, 3.8, 14.38, 8.2)
)
